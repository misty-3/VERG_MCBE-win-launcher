    ...
    public static class Localization
    {
        ...
        private static Dictionary<string, Dictionary<string, string>> _translations = new Dictionary<string, Dictionary<string, string>>
        {
            ...
            ["en"] = new Dictionary<string, string>
            {
                ...
                ["UnlockDownloadFailedTitle"] = "Unlock Failed",
                ["UnlockDownloadFailedMessage"] = "Couldn't download the unlock files. Check your internet connection and try again.\n\nDetails: {0}",
            ...
            ["ar"] = new Dictionary<string, string>
            {
                ...
                ["UnlockDownloadFailedTitle"] = "فشل فك القفل",
                ["UnlockDownloadFailedMessage"] = "ما قدرنا ننزّل ملفات فك القفل. تأكد من اتصال الإنترنت وحاول مرة ثانية.\n\nالتفاصيل: {0}",
